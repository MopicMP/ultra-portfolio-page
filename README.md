# ultra-portfolio-page

> Ultra developer portfolio page template

[![PyPI version](https://badge.fury.io/py/ultra-portfolio-page.svg)](https://pypi.org/project/ultra-portfolio-page/)
...
```bash
pip install ultra-portfolio-page
```
...
from ultra_portfolio_page import batch
